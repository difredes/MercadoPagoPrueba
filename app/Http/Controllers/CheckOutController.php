	...
	public function index(Request $request){
     ...
     // $this->mp_app_id     = config('mercadopago.app_id');
      ...
      $preference = new Preference();
        ...
        $items=array();
         ...
         // $quantity=(int)addslashes($request->unit);
          ...
          $preference->back_urls = array(
           ...
           "success" => "https://difredes-mp-commerce-php.herokuapp.com/backurl/success",
            "failure" => "https://difredes-mp-commerce-php.herokuapp.com/backurl/failure",
            "pending" => "https://difredes-mp-commerce-php.herokuapp.com/backurl/pending"
        );
        ...
        $preference->notification_url= "https://difredes-mp-commerce-php.herokuapp.com/notification";
